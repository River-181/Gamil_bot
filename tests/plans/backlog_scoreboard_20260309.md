...
- estimated after focused `Notion/Apple` apply:
  - `inbox`: `9,276`
  - `has:nouserlabels`: `6,728`
  - `has:userlabels`: `4,499`
  - note: 직전 정확 baseline에서 focused apply `33건`(`Notion 10`, `Apple 10`, `Notion newsletter 13`)을 반영한 추정치, full recount pending
